!(function () {
    var h,
        ...
        P = function (t) {
            var e = new P.Index();
            return (
                e.pipeline.add(P.trimmer, P.stopWordFilter, P.stemmer),
                t && t.call(e, e),
                e
            );
        };
    (P.version = "0.9.5"),
        ...
        (P.utils.warn =
            ((i = this),
            function (t) {
                i.console && console.warn && console.warn(t);
            })),
        (P.utils.toString = function (t) {
            return null == t ? "" : t.toString();
        }),
        (P.EventEmitter = function () {
            this.events = {};
        }),
        (P.EventEmitter.prototype.addListener = function () {
        ...
        (P.EventEmitter.prototype.removeListener = function (t, e) {
            !this.hasHandler(t) ||
                (-1 !== (e = this.events[t].indexOf(e)) &&
                    (this.events[t].splice(e, 1),
                    0 == this.events[t].length && delete this.events[t]));
        }),
        (P.EventEmitter.prototype.emit = function (t) {
            var e;
            this.hasHandler(t) &&
        ...
        (P.EventEmitter.prototype.hasHandler = function (t) {
            return t in this.events;
        }),
        (P.tokenizer = function (t) {
            if (!arguments.length || null == t) return [];
            if (Array.isArray(t)) {
                var e = (e = t.filter(function (t) {
                        return null != t;
                    })).map(function (t) {
                        return P.utils.toString(t).toLowerCase();
                    }),
                    i = [];
                return (
                    e.forEach(function (t) {
                        t = t.split(P.tokenizer.seperator);
                        i = i.concat(t);
                    }, this),
                    i
                );
            ...
            return t
                ...
                .trim()
                .toLowerCase()
                .split(P.tokenizer.seperator);
        }),
        (P.tokenizer.defaultSeperator = /[\s\-]+/),
        (P.tokenizer.seperator = P.tokenizer.defaultSeperator),
        (P.tokenizer.setSeperator = function (t) {
            null != t && "object" == typeof t && (P.tokenizer.seperator = t);
        }),
        (P.tokenizer.resetSeperator = function () {
            P.tokenizer.seperator = P.tokenizer.defaultSeperator;
        }),
        (P.tokenizer.getSeperator = function () {
            return P.tokenizer.seperator;
        }),
        (P.Pipeline = function () {
            this._queue = [];
        }),
        (P.Pipeline.registeredFunctions = {}),
        (P.Pipeline.registerFunction = function (t, e) {
            e in P.Pipeline.registeredFunctions &&
                P.utils.warn("Overwriting existing registered function: " + e),
                (t.label = e),
                (P.Pipeline.registeredFunctions[e] = t);
        }),
        (P.Pipeline.getRegisteredFunction = function (t) {
            return t in P.Pipeline.registeredFunctions != 1
                ? null
                : P.Pipeline.registeredFunctions[t];
        }),
        (P.Pipeline.warnIfFunctionNotRegistered = function (t) {
        ...
        (P.Pipeline.load = function (t) {
            var i = new P.Pipeline();
            return (
                t.forEach(function (t) {
                    var e = P.Pipeline.getRegisteredFunction(t);
                    if (!e)
                        throw new Error(
                            "Cannot load un-registered function: " + t
                        );
                    i.add(e);
                }),
                i
        ...
        (P.Pipeline.prototype.add = function () {
            Array.prototype.slice.call(arguments).forEach(function (t) {
                P.Pipeline.warnIfFunctionNotRegistered(t), this._queue.push(t);
            }, this);
        }),
        (P.Pipeline.prototype.after = function (t, e) {
            P.Pipeline.warnIfFunctionNotRegistered(e);
            t = this._queue.indexOf(t);
            if (-1 === t) throw new Error("Cannot find existingFn");
            this._queue.splice(t + 1, 0, e);
        }),
        (P.Pipeline.prototype.before = function (t, e) {
            P.Pipeline.warnIfFunctionNotRegistered(e);
            t = this._queue.indexOf(t);
            if (-1 === t) throw new Error("Cannot find existingFn");
            this._queue.splice(t, 0, e);
        }),
        (P.Pipeline.prototype.remove = function (t) {
            t = this._queue.indexOf(t);
            -1 !== t && this._queue.splice(t, 1);
        }),
        (P.Pipeline.prototype.run = function (t) {
            for (
                var e = [], i = t.length, n = this._queue.length, s = 0;
                s < i;
                s++
            ) {
                for (
                    var o = t[s], r = 0;
                    r < n && null != (o = this._queue[r](o, s, t));
                    r++
                );
                null != o && e.push(o);
            }
        ...
        (P.Pipeline.prototype.get = function () {
            return this._queue;
        }),
        (P.Pipeline.prototype.toJSON = function () {
            return this._queue.map(function (t) {
                return P.Pipeline.warnIfFunctionNotRegistered(t), t.label;
            });
        }),
        (P.Index = function () {
            (this._fields = []),
                ...
                (this.documentStore = new P.DocumentStore()),
                (this.index = {}),
        ...
        (P.Index.prototype.on = function () {
            var t = Array.prototype.slice.call(arguments);
            return this.eventEmitter.addListener.apply(this.eventEmitter, t);
        }),
        (P.Index.prototype.off = function (t, e) {
            return this.eventEmitter.removeListener(t, e);
        }),
        (P.Index.load = function (t) {
            t.version !== P.version &&
                P.utils.warn(
            ...
            var e,
                i = new this();
            for (e in ((i._fields = t.fields),
            (i._ref = t.ref),
            (i.documentStore = P.DocumentStore.load(t.documentStore)),
            (i.pipeline = P.Pipeline.load(t.pipeline)),
            (i.index = {}),
            t.index))
                i.index[e] = P.InvertedIndex.load(t.index[e]);
            return i;
        }),
        (P.Index.prototype.addField = function (t) {
            return (
                this._fields.push(t),
                (this.index[t] = new P.InvertedIndex()),
                this
            );
        }),
        (P.Index.prototype.setRef = function (t) {
            return (this._ref = t), this;
        }),
        (P.Index.prototype.saveDocument = function (t) {
            return (this.documentStore = new P.DocumentStore(t)), this;
        }),
        (P.Index.prototype.addDoc = function (o, t) {
            var r;
            o &&
                ((t = void 0 === t || t),
                (r = o[this._ref]),
                this.documentStore.addDoc(r, o),
                this._fields.forEach(function (t) {
                    var e = this.pipeline.run(P.tokenizer(o[t]));
                    this.documentStore.addFieldLength(r, t, e.length);
                    var i,
                        n = {};
                    ...
                    n)) {
                        var s = n[i],
                            s = Math.sqrt(s);
                        this.index[t].addToken(i, { ref: r, tf: s });
                    }
                }, this),
                t && this.eventEmitter.emit("add", o, this));
        }),
        (P.Index.prototype.removeDocByRef = function (t) {
            t &&
                !1 !== this.documentStore.isDocStored() &&
                this.documentStore.hasDoc(t) &&
                ((t = this.documentStore.getDoc(t)), this.removeDoc(t, !1));
        }),
        (P.Index.prototype.removeDoc = function (t, e) {
            var i;
            t &&
                ((e = void 0 === e || e),
                (i = t[this._ref]),
                this.documentStore.hasDoc(i) &&
                    ...
                    this._fields.forEach(function (e) {
                        this.pipeline
                            .run(P.tokenizer(t[e]))
                            .forEach(function (t) {
                                this.index[e].removeToken(t, i);
                            }, this);
                    }, this),
                    e && this.eventEmitter.emit("remove", t, this)));
        }),
        (P.Index.prototype.updateDoc = function (t, e) {
            e = void 0 === e || e;
            this.removeDocByRef(t[this._ref], !1),
                this.addDoc(t, !1),
                e && this.eventEmitter.emit("update", t, this);
        }),
        (P.Index.prototype.idf = function (t, e) {
            var i = "@" + e + "/" + t;
            if (Object.prototype.hasOwnProperty.call(this._idfCache, i))
                return this._idfCache[i];
            (t = this.index[e].getDocFreq(t)),
                (t = 1 + Math.log(this.documentStore.length / (t + 1)));
            return (this._idfCache[i] = t);
        }),
        (P.Index.prototype.getFields = function () {
            return this._fields.slice();
        }),
        (P.Index.prototype.search = function (t, e) {
            if (!t) return [];
            t =
                "string" == typeof t
                    ? { any: t }
            ...
            var i = null;
            null != e && (i = JSON.stringify(e));
            for (
                var n = new P.Configuration(i, this.getFields()).get(),
                    s = {},
                    o = Object.keys(t),
                    r = 0;
                r < o.length;
                ...
                var a = o[r];
                s[a] = this.pipeline.run(P.tokenizer(t[a]));
            }
            var l,
                h = {};
            for (l in n) {
                var c = s[l] || s.any;
                if (c) {
                    var u = this.fieldSearch(c, l, n),
                        d = n[l].boost;
                    for (f in u) u[f] = u[f] * d;
                    for (f in u) f in h ? (h[f] += u[f]) : (h[f] = u[f]);
                }
            }
            var p,
                f,
        ...
        (P.Index.prototype.fieldSearch = function (t, u, e) {
            var d = e[u].bool,
                i = e[u].expand,
                e = e[u].boost,
                p = null,
            ...
            return 0 !== e
                ? (t.forEach(function (h) {
                      var t = [h];
                      1 == i && (t = this.index[u].expandToken(h));
                      var c = {};
                      t.forEach(function (t) {
                          var e = this.index[u].getDocs(t),
                              i = this.idf(t, u);
                          if (p && "AND" == d) {
                              var n,
                                  s = {};
                              for (n in p) n in e && (s[n] = e[n]);
                              e = s;
                          }
                          for (n in (t == h && this.fieldSearchStats(f, t, e),
                          e)) {
                              var o = this.index[u].getTermFrequency(t, n),
                                  r = this.documentStore.getFieldLength(n, u),
                                  a = 1,
                                  l = 1,
                                  l =
                                      o *
                                      i *
                                      (a = 0 != r ? 1 / Math.sqrt(r) : a) *
                                      (l =
                                          t != h
                                              ? 0.15 *
                                                (1 -
                          ...
                          (p = this.mergeScores(p, c, d));
                  }, this),
                  (p = this.coordNorm(p, f, t.length)))
                : void 0;
        }),
        (P.Index.prototype.mergeScores = function (t, e, i) {
            if (!t) return e;
            if ("AND" == i) {
                var n = {};
                for (s in e) s in t && (n[s] = t[s] + e[s]);
                return n;
            }
            for (var s in e) s in t ? (t[s] += e[s]) : (t[s] = e[s]);
            return t;
        }),
        (P.Index.prototype.fieldSearchStats = function (t, e, i) {
            for (var n in i) n in t ? t[n].push(e) : (t[n] = [e]);
        }),
        (P.Index.prototype.coordNorm = function (t, e, i) {
            for (var n in t) {
                var s;
                n in e && ((s = e[n].length), (t[n] = (t[n] * s) / i));
            }
            return t;
        }),
        ...
        (P.Index.prototype.use = function (t) {
            var e = Array.prototype.slice.call(arguments, 1);
            e.unshift(this), t.apply(this, e);
        }),
        (P.DocumentStore = function (t) {
            (this._save = null == t || t),
                (this.docs = {}),
                (this.docInfo = {}),
                (this.length = 0);
        }),
        (P.DocumentStore.load = function (t) {
            var e = new this();
            return (
                (e.length = t.length),
                (e.docs = t.docs),
        ...
        (P.DocumentStore.prototype.isDocStored = function () {
            return this._save;
        }),
        (P.DocumentStore.prototype.addDoc = function (t, e) {
        ...
        (P.DocumentStore.prototype.getDoc = function (t) {
            return !1 === this.hasDoc(t) ? null : this.docs[t];
        }),
        (P.DocumentStore.prototype.hasDoc = function (t) {
            return t in this.docs;
        }),
        (P.DocumentStore.prototype.removeDoc = function (t) {
            this.hasDoc(t) &&
                (delete this.docs[t], delete this.docInfo[t], this.length--);
        }),
        (P.DocumentStore.prototype.addFieldLength = function (t, e, i) {
            null != t &&
                0 != this.hasDoc(t) &&
                (this.docInfo[t] || (this.docInfo[t] = {}),
                (this.docInfo[t][e] = i));
        }),
        (P.DocumentStore.prototype.updateFieldLength = function (t, e, i) {
            null != t && 0 != this.hasDoc(t) && this.addFieldLength(t, e, i);
        }),
        (P.DocumentStore.prototype.getFieldLength = function (t, e) {
            return null != t && t in this.docs && e in this.docInfo[t]
                ? this.docInfo[t][e]
                : 0;
        }),
        (P.DocumentStore.prototype.toJSON = function () {
            return {
                docs: this.docs,
        ...
        (P.stemmer =
            ...
            (I = /^(.+?)e$/),
            (A = /ll$/),
            (D = new RegExp("^" + e + t + "[^aeiouwxy]$")),
            function (t) {
                var e, i, n, s, o, r, a, l;
                return t.length < 3
                    ? t
                    : ("y" == (i = t.substr(0, 1)) &&
                          (t = i.toUpperCase() + t.substr(1)),
                      (a = m),
                      (o = g).test(t)
                          ? (t = t.replace(o, "$1$2"))
                          : a.test(t) && (t = t.replace(a, "$1$2")),
                      (a = v),
                      (o = y).test(t)
                          ? ((l = o.exec(t)),
                            (o = u).test(l[1]) && (t = t.replace((o = _), "")))
                          : a.test(t) &&
                            ((r = (l = a.exec(t))[1]),
                            (a = f).test(r) &&
                                ((n = x),
                      ...
                      (o = I).test(t) &&
                          ...
                          (a = p),
                          (n = D),
                          ((o = d).test(r) || (a.test(r) && !n.test(r))) &&
                              (t = r)),
                      (a = d),
                      (o = A).test(t) &&
                          a.test(t) &&
                          (t = t.replace((o = _), "")),
                      "y" == i ? i.toLowerCase() + t.substr(1) : t);
            })),
        P.Pipeline.registerFunction(P.stemmer, "stemmer"),
        (P.stopWordFilter = function (t) {
            return t && !0 !== P.stopWordFilter.stopWords[t] ? t : void 0;
        }),
        (P.clearStopWords = function () {
            P.stopWordFilter.stopWords = {};
        }),
        (P.addStopWords = function (t) {
            null != t &&
                !1 !== Array.isArray(t) &&
                t.forEach(function (t) {
                    P.stopWordFilter.stopWords[t] = !0;
                }, this);
        }),
        (P.resetStopWords = function () {
            P.stopWordFilter.stopWords = P.defaultStopWords;
        }),
        (P.defaultStopWords = {
            "": !0,
            a: !0,
        ...
        (P.trimmer = function (t) {
            if (null == t) throw new Error("token should not be undefined");
            return t.replace(/^\W+/, "").replace(/\W+$/, "");
        }),
        P.Pipeline.registerFunction(P.trimmer, "trimmer"),
        (P.InvertedIndex = function () {
            this.root = { docs: {}, df: 0 };
        }),
        (P.InvertedIndex.load = function (t) {
            var e = new this();
            return (e.root = t.root), e;
        }),
        (P.InvertedIndex.prototype.addToken = function (t, e, i) {
            for (var i = i || this.root, n = 0; n <= t.length - 1; ) {
                var s = t[n];
                s in i || (i[s] = { docs: {}, df: 0 }), (n += 1), (i = i[s]);
            }
            var o = e.ref;
            i.docs[o]
                ? (i.docs[o] = { tf: e.tf })
                : ((i.docs[o] = { tf: e.tf }), (i.df += 1));
        }),
        (P.InvertedIndex.prototype.hasToken = function (t) {
            if (!t) return !1;
        ...
        (P.InvertedIndex.prototype.getNode = function (t) {
            if (!t) return null;
            for (var e = this.root, i = 0; i < t.length; i++) {
        ...
        (P.InvertedIndex.prototype.getDocs = function (t) {
            t = this.getNode(t);
            return null == t ? {} : t.docs;
        }),
        (P.InvertedIndex.prototype.getTermFrequency = function (t, e) {
            t = this.getNode(t);
            return null != t && e in t.docs ? t.docs[e].tf : 0;
        }),
        (P.InvertedIndex.prototype.getDocFreq = function (t) {
            t = this.getNode(t);
            return null == t ? 0 : t.df;
        }),
        (P.InvertedIndex.prototype.removeToken = function (t, e) {
            !t ||
                (null != (t = this.getNode(t)) &&
                    e in t.docs &&
                    (delete t.docs[e], --t.df));
        }),
        (P.InvertedIndex.prototype.expandToken = function (t, e, i) {
            if (null == t || "" == t) return [];
            var n,
                e = e || [];
            if (null == i && null == (i = this.getNode(t))) return e;
            for (n in (0 < i.df && e.push(t), i))
                "docs" !== n && "df" !== n && this.expandToken(t + n, e, i[n]);
            return e;
        }),
        (P.InvertedIndex.prototype.toJSON = function () {
            return { root: this.root };
        }),
        (P.Configuration = function (t, e) {
            var i,
                t = t || "";
            if (null == e || null == e)
            ...
            this.config = {};
            try {
                (i = JSON.parse(t)), this.buildUserConfig(i, e);
            } catch (t) {
                P.utils.warn(
                    "user configuration parse failed, will use default configuration"
                ),
                    this.buildDefaultConfig(e);
            }
        }),
        (P.Configuration.prototype.buildDefaultConfig = function (t) {
            this.reset(),
                t.forEach(function (t) {
                    this.config[t] = { boost: 1, bool: "OR", expand: !1 };
                }, this);
        }),
        (P.Configuration.prototype.buildUserConfig = function (t, e) {
            var i,
                n,
                s = "OR",
                o = !1;
            if (
                ...
                for (var r in t.fields)
                    -1 < e.indexOf(r)
                        ? ((n = o),
                          null != (i = t.fields[r]).expand && (n = i.expand),
                          (this.config[r] = {
            ...
            else this.addAllFields2UserConfig(s, o, e);
        }),
        (P.Configuration.prototype.addAllFields2UserConfig = function (
            e,
            i,
            t
        ) {
            t.forEach(function (t) {
                this.config[t] = { boost: 1, bool: e, expand: i };
            }, this);
        }),
        (P.Configuration.prototype.get = function () {
            return this.config;
        }),
        (P.Configuration.prototype.reset = function () {
            this.config = {};
        }),
        ...
        (lunr.SortedSet.prototype.indexOf = function (t) {
            for (
                var e = 0,
                ...
                if (o === t) return s;
                (n = (i = t < o ? s : i) - (e = o < t ? s : e)),
                    (s = e + Math.floor(n / 2)),
                    (o = this.elements[s]);
            }
            return o === t ? s : -1;
        }),
        (lunr.SortedSet.prototype.locationFor = function (t) {
            for (
                var e = 0,
                    i = this.elements.length,
                    n = i - e,
        ...
        (lunr.SortedSet.prototype.clone = function () {
            ...
            return (
                (t.elements = this.toArray()), (t.length = t.elements.length), t
            );
        }),
    ...
    (function (i) {
        ...
        function (t, e, i) {
            ...
            var n,
                a = s.window.jarallax;
            (s.window.jarallax = o.default),
                (s.window.jarallax.noConflict = function () {
                    return (s.window.jarallax = a), this;
                }),
                void 0 !== s.jQuery &&
                    (((i = function () {
                        for (
                        ...
                        var n = o.default.apply(s.window, e);
                        return "object" !== r(n) ? n : this;
                    }).constructor = o.default.constructor),
                    (n = s.jQuery.fn.jarallax),
                    (s.jQuery.fn.jarallax = i),
                    (s.jQuery.fn.jarallax.noConflict = function () {
                        return (s.jQuery.fn.jarallax = n), this;
                    })),
                e()(function () {
                    Object(o.default)(
        ...
        function (t, e, i) {
            ...
            var o,
                ...
                r =
                    -1 < c.userAgent.indexOf("MSIE ") ||
                    -1 < c.userAgent.indexOf("Trident/") ||
                    -1 < c.userAgent.indexOf("Edge/"),
                a =
            ...
            function m() {
                p.length &&
                    ...
                    f.window.requestAnimationFrame(m));
            }
            function y(t, e) {
                for (
                    var i,
                ...
                for (; s < n; s += 1)
                    if (
                        ("object" === h(e) || void 0 === e
                            ? t[s].jarallax || (t[s].jarallax = new _(t[s], e))
                            : t[s].jarallax &&
                              (i = t[s].jarallax[e].apply(t[s].jarallax, r)),
                        void 0 !== i)
                    )
                        return i;
                return t;
                    ...
                    (s(w.prototype, [
                            ...
                            value: function (i) {
                                ...
                                return (
                                    ...
                                    Object.keys(n).forEach(function (e) {
                                        n[e] &&
                                            Object.keys(n[e]).forEach(function (
                                                t
                                            ) {
                                                i[t] = n[e][t];
                                            });
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var i = this;
                                p.forEach(function (t, e) {
                                    t.instance.instanceID === i.instanceID &&
                                        p.splice(e, 1);
                                });
                            },
                        },
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                var e,
                                    ...
                                    a,
                                    l = this,
                                    h = l.$item.getBoundingClientRect(),
                                    c = h.top,
                                    u = h.height,
                                    d = {},
                                    p = h;
            ...
            function w(t, e) {
                ...
                Object.keys(o).forEach(function (t) {
                    ...
                    i.options.disableVideo instanceof RegExp &&
                        ((s = i.options.disableVideo),
                        (i.options.disableVideo = function () {
                            return s.test(c.userAgent);
                        })),
                ...
                a &&
                    ...
                    (i.image = {
                        ...
                        $container: null,
                        useImgTag: !1,
                        position: /iPad|iPhone|iPod|Android/.test(c.userAgent)
                            ? "absolute"
                            : "fixed",
                    }),
                    i.initImg() && i.canInitParallax() && i.init();
            }
            (y.constructor = _), (e.default = y);
        },
    ]),
    (function (o) {
        "use strict";
            ...
            if (M.getElementsByClassName) {
                ...
                var t = (function () {
                        var p,
                            ...
                            i = K(t),
                            P = function (t) {
                                q(t.target, F.loadedClass),
                                    Q(t.target, F.loadingClass),
                                    J(t.target, T),
                            ...
                            j = function (t) {
                                ...
                                (e =
                                    F.customMedia[
                                        t[W]("data-media") || t[W]("media")
                                    ]) && t.setAttribute("media", e),
                                    i && t.setAttribute("srcset", i);
                            },
                            r = Y(function (t, e, i, n, s) {
                                var o, r, a, l, h, c;
                                (h = U(t, "lazybeforeunveil", e))
                                    .defaultPrevented ||
                                    (n &&
                                        (i
                                            ? q(t, F.autosizesClass)
                                            : t.setAttribute("sizes", n)),
                                    (r = t[W](F.srcsetAttr)),
                                    (o = t[W](F.srcAttr)),
                                    s &&
                                        ((a = t.parentNode),
                                        (l = a && H.test(a.nodeName || ""))),
                                    (c =
                                        e.firesLoad ||
                                        ("src" in t && (r || o || l))),
                                    (h = { target: t }),
                            ...
                            O = function (t) {
                                ...
                                ((!s && f) ||
                                    ...
                                    s && et.updateElem(t, !0, t.offsetWidth),
                                    (t._lazyRace = !0),
                                    z++,
                                    r(t, e, s, n, i));
                            },
                        ...
                        return {
                            _: function () {
                                (e = l.now()),
                                    (N.elements = M.getElementsByClassName(
                                        F.lazyClass
                                    )),
                                    ...
                                    a.MutationObserver
                                        ...
                                        : (L[h]("DOMNodeInserted", i, !0),
                                          L[h]("DOMAttrModified", i, !0),
                                          setInterval(i, 999)),
                                    c("hashchange", i, !0),
                                    [
                                        "focus",
    ...
    (function (s, o) {
        ...
        !(function () {
            ...
            (s.support.transition.end =
                i.transition.end[s.support.transition])),
            h() &&
                ((s.support.animation = new String(t("animation"))),
                (s.support.animation.end =
                    i.animation.end[s.support.animation])),
            n() &&
...
function search() {
    ...
    function r(t) {
        t.posts.forEach(function (t) {
            ...
            localStorage.setItem("ease_search_index", JSON.stringify(o)),
            localStorage.setItem("ease_search_last", t.posts[0].updated_at);
    }
    "undefined" != typeof gh_search_key &&
        "" != gh_search_key &&
        "undefined" != typeof gh_search_migration &&
        ((e = $(".search-field")),
        (n = $(".search-button")),
        (s = $(".search-result")),
        (t =
        ...
        (i = JSON.parse(localStorage.getItem("ease_search_index"))),
            ...
            ? ((o = elasticlunr.Index.load(i)),
              $.get(
                  t +
                      ...
                      "'",
                  function (t) {
                      0 < t.posts.length && r(t);
                  }
              ))
            : $.get(t, function (t) {
                  0 < t.posts.length &&
                      ((o = elasticlunr(function () {
                          this.addField("title"),
        ...
        e.on("keyup", function (t) {
            var e = o.search(t.target.value, { expand: !0 }),
                i = "";
            e.forEach(function (t) {
                i +=
                ...
                0 < t.target.value.length
                    ? n.addClass("search-button-clear")
                    : n.removeClass("search-button-clear");
        }),
        $(".search-form").on("submit", function (t) {
            t.preventDefault();
        }),
        n.on("click", function () {
            $(this).hasClass("search-button-clear") &&
                e.val("").focus().keyup();
        }),
        $(document).keyup(function (t) {
            27 === t.keyCode && e.val("").focus().keyup();
        }));
}
function featured() {
    "use strict";
...
$(function () {
    "use strict";
    search(), featured(), video(), gallery(), table(), mobileMenu();
}),
    document.addEventListener("lazyloaded", function (t) {
        "use strict";
        $(t.target).parent(".site-cover").length &&
            $(t.target)
                .parent()
                .jarallax({
