var OneTrustStub = (function (e) {
  ...
  ((o = t = t || {})[(o.Unknown = 0)] = "Unknown"),
    ...
    ((I = C = C || {})[(I.Disabled = 0)] = "Disabled"),
    (I[(I.Consent = 1)] = "Consent"),
    (I[(I.LegInt = 2)] = "LegInt"),
    ((S = w = w || {})[(S["Banner - Allow All"] = 1)] = "Banner - Allow All"),
    (S[(S["Banner - Reject All"] = 2)] = "Banner - Reject All"),
    (S[(S["Banner - Close"] = 3)] = "Banner - Close"),
    (S[(S["Preference Center - Allow All"] = 4)] =
      "Preference Center - Allow All"),
    (S[(S["Preference Center - Reject All"] = 5)] =
      "Preference Center - Reject All"),
    (S[(S["Preference Center - Confirm"] = 6)] = "Preference Center - Confirm"),
    ((L = T = T || {}).Active = "1"),
    (L.InActive = "0"),
    ((B = R = R || {}).Host = "Host"),
    (B.GenVendor = "GenVen"),
    ((P = D = D || {})[(P.Host = 1)] = "Host"),
    (P[(P.GenVen = 2)] = "GenVen"),
    (P[(P.HostAndGenVen = 3)] = "HostAndGenVen"),
    ((E = _ = _ || {})[(E.minDays = 1)] = "minDays"),
    ...
    (V[(V.Years = 365)] = "Years"),
    ((x = N = N || {}).Checkbox = "Checkbox"),
    (x.Toggle = "Toggle"),
    ((H = j = j || {}).SlideIn = "Slide_In"),
    (H.FadeIn = "Fade_In"),
    (H.RemoveAnimation = "Remove_Animation"),
    ((K = M = M || {}).Link = "Link"),
    (K.Icon = "Icon"),
    ((q = z = z || {}).consent = "consent"),
    (q.set = "set"),
    ((W = J = J || {}).update = "update"),
    (W.default = "default"),
    (W.ads_data_redaction = "ads_data_redaction"),
  ...
  var te = "geo",
    ...
    ne =
      ...
      ($[F.Years] = "LfSpnYr"),
      (ie.prototype.camelize = function (e) {
        return e
          .split("-")
          .map(function (e, t) {
  ...
  var re =
    ...
    (se.prototype.getLocation = function (e) {
      ...
      if (o.OneTrust && o.OneTrust.geolocationResponse) {
        ...
        this.setGeoLocation(n.countryCode, n.stateCode),
          this.addBannerSDKScript(e);
      } else {
      ...
      if (new RegExp("^file://", "i").test(o) && e.MobileSDK) {
        var n =
          ...
          e.GeolocationUrl.replace(/^(http|https):\/\//, "")
            ...
            .join("/") +
          ".js";
        return t && t.CookieV2GeolocationJsonApi
          ? ee.storageBaseURL + n
          : "." + n;
      }
    ...
    (se.prototype.getGeoLocation = function (e) {
      ...
      o && o.CookieV2GeolocationJsonApi
        ? this.otFetch(n, this.geoLocationJsonCallback.bind(this, e), !0)
      ...
      (window.OnetrustActiveGroups = o),
        ...
        void 0 !== window.dataLayer
          ? window.dataLayer.constructor === Array &&
            (window.dataLayer.push({ OnetrustActiveGroups: o }),
            window.dataLayer.push({ OptanonActiveGroups: o }))
          : (window.dataLayer = [
              { event: "OneTrustLoaded", OnetrustActiveGroups: o },
              { event: "OptanonLoaded", OptanonActiveGroups: o },
            ]);
      var n,
        i = new CustomEvent("consent.onetrust", { detail: t });
      t.length &&
        (window.dataLayer.constructor === Array &&
